...
whoami
echo "$password" | sudo -S sleep 3  && sudo yum update
echo "$password" | sudo -S sleep 3 && sudo yum install -y ansible
echo "$password" | sudo -S sleep 3 && sudo yum install -y git
mkdir ansiblecode 
cd ansiblecode
